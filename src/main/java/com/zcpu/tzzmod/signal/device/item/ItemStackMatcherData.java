...
public record ItemStackMatcherData(
    ...
    public ItemStackMatcherData(
        ...
        this(
                ...
                interactionItemInventoryConsumeOrder,
                interactionItemSource,
                interactionItemVanillaPolicy,
                lastInteractionItemSource,
                lastInteractionItemMatchedSlot,
                lastInteractionItemMatchedCount,
                lastInteractionItemSourceResult,
                lastInteractionItemConsumeSource,
                lastInteractionItemConsumedSlots,
                lastInteractionItemConsumeResult,
                createdWallTimeMillis,
                updatedWallTimeMillis
        );
    }
    ...
    public ItemStackMatcherData normalized() {
        ...
        String cleanDisplayStack = templateDisplayStack == null ? "" : templateDisplayStack.trim();
