...
public record ConditionContainerSnapshot(List<ConditionItemStackSnapshot> slots) {
    public ConditionContainerSnapshot {
        slots = copySlots(slots);
    }

    public static ConditionContainerSnapshot empty() {
        return new ConditionContainerSnapshot(List.of());
    }
