                    ...
                    <aside class="sidebar" data-ui="v75">
                      ...
                      <nav class="nav-list" data-ui="v75" aria-label="主导航">
                        ...
                        <div class="nav-section">
                          ...
                          <button class="nav-item" data-route="#/signal-joins"><span class="nav-icon" data-icon="signal-join"></span>信号汇合</button>
                          <button class="nav-item" data-route="#/logic-chains"><span class="nav-icon" data-icon="logic-chain"></span>逻辑链</button>
                          <button class="nav-item" data-route="#/condition-groups"><span class="nav-icon" data-icon="condition-group"></span>条件组</button>
                          <button class="nav-item" data-route="#/condition-debugger"><span class="nav-icon" data-icon="condition-debugger"></span>条件调试</button>
                          <button class="nav-item" data-route="#/state-variables"><span class="nav-icon" data-icon="state-variable"></span>状态变量</button>
                          <button class="nav-item" data-route="#/timers"><span class="nav-icon" data-icon="timer"></span>调度器 / 计时器</button>
