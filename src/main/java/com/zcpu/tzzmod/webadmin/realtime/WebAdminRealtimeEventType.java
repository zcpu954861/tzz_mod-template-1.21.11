...
public enum WebAdminRealtimeEventType {
    ...
    TIMER_CHANGED("timer_changed", "Timer 配置已变化"),
    TIMER_RUNTIME_CHANGED("timer_runtime_changed", "Timer 运行态已变化"),
    ...
    SNAPSHOT_CREATED("snapshot_created", "配置快照已创建"),
    ...
    SINGLE_ITEM_SUBMIT_TEMPLATE_SESSION_STARTED("single_item_submit_template_session_started", "单物品提交模板会话已开始"),
    SINGLE_ITEM_SUBMIT_TEMPLATE_SESSION_OPENED("single_item_submit_template_session_opened", "单物品提交模板 GUI 已打开"),
    SINGLE_ITEM_SUBMIT_TEMPLATE_SESSION_SAVED("single_item_submit_template_session_saved", "单物品提交模板会话已保存"),
    SINGLE_ITEM_SUBMIT_TEMPLATE_SESSION_CANCELLED("single_item_submit_template_session_cancelled", "单物品提交模板会话已取消"),
    SINGLE_ITEM_SUBMIT_TEMPLATE_SESSION_FAILED("single_item_submit_template_session_failed", "单物品提交模板会话失败"),
    SINGLE_ITEM_SUBMIT_TEMPLATE_SESSION_EXPIRED("single_item_submit_template_session_expired", "单物品提交模板会话已过期"),
