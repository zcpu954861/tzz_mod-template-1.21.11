        ...
        return switch (safeRole) {
            ...
            case EDITOR -> switch (operation) {
                case READ, TEST, ACQUIRE_EDIT_LOCK, RELEASE_EDIT_LOCK,
                        ...
                        EDIT_CHANNEL_METADATA, EDIT_LOGIC_CHAIN_METADATA, EDIT_LOGIC_CHAIN, EDIT_CONDITION_GROUP, EDIT_SIGNAL_LISTENER_BASIC_CONFIG, EDIT_SIGNAL_LISTENER_ACTIONS, START_OBJECT_SELECTION,
