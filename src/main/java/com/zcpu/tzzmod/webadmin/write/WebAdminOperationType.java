...
public enum WebAdminOperationType {
    ...
    START_VIRTUAL_BLOCK_DEVICE_SINGLE_ITEM_SUBMIT_SESSION("START_VIRTUAL_BLOCK_DEVICE_SINGLE_ITEM_SUBMIT_SESSION", "发起 VBD 单物品提交模板会话"),
    SAVE_VIRTUAL_BLOCK_DEVICE_SINGLE_ITEM_SUBMIT("SAVE_VIRTUAL_BLOCK_DEVICE_SINGLE_ITEM_SUBMIT", "保存 VBD 单物品提交模板"),
    CANCEL_VIRTUAL_BLOCK_DEVICE_SINGLE_ITEM_SUBMIT_SESSION("CANCEL_VIRTUAL_BLOCK_DEVICE_SINGLE_ITEM_SUBMIT_SESSION", "取消 VBD 单物品提交模板会话"),
    FAIL_VIRTUAL_BLOCK_DEVICE_SINGLE_ITEM_SUBMIT_SESSION("FAIL_VIRTUAL_BLOCK_DEVICE_SINGLE_ITEM_SUBMIT_SESSION", "结束失败的 VBD 单物品提交模板会话"),
    EDIT_CHANNEL_METADATA("EDIT_CHANNEL_METADATA", "编辑 WebAdmin 频道显示信息"),
    EDIT_LOGIC_CHAIN_METADATA("EDIT_LOGIC_CHAIN_METADATA", "编辑 WebAdmin 逻辑链显示信息"),
    EDIT_LOGIC_CHAIN("EDIT_LOGIC_CHAIN", "编辑 Logic Chain 新增节点草稿"),
    IMPORT_TEMPLATE("IMPORT_TEMPLATE", "导入 WebAdmin 模板"),
    APPLY_TEMPLATE("APPLY_TEMPLATE", "应用 WebAdmin 模板"),
    VIEW_SNAPSHOTS("VIEW_SNAPSHOTS", "查看配置快照时间轴"),
    CREATE_SNAPSHOT("CREATE_SNAPSHOT", "创建配置快照"),
